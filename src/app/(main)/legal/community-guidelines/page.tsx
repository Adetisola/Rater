  ...
  return (
    <div className="space-y-5 sm:space-y-6 w-full max-w-full min-w-0">
      ...
      <div className="space-y-2">
        ...
        <div className="rounded-2xl border border-gray-100 bg-white p-4 sm:p-6 shadow-2xs space-y-1.5">
      ...
      <div className="p-4 sm:p-6 rounded-2xl bg-amber-50/70 border border-primary/20 space-y-2 shadow-2xs">
