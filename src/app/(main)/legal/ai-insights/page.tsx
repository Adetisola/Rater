  ...
  return (
    <div className="space-y-5 sm:space-y-6 w-full max-w-full min-w-0">
      ...
      <div className="space-y-2">
        ...
        <div className="rounded-2xl border border-border-default bg-surface-primary p-4 sm:p-6 shadow-2xs space-y-3">
          <p className="text-xs text-text-secondary leading-relaxed">Insights may use:</p>
          <ul className="text-xs text-text-secondary space-y-1.5 list-disc list-inside pl-1">
      ...
      <div className="space-y-2">
        ...
        <div className="rounded-2xl border border-border-default bg-surface-primary p-4 sm:p-6 shadow-2xs space-y-3">
          <p className="text-xs text-text-secondary font-medium">Insights are not:</p>
          <ul className="text-xs text-text-secondary space-y-1.5 list-disc list-inside pl-1">
      ...
      <div className="space-y-2">
        ...
        <div className="rounded-2xl border border-border-default bg-surface-primary p-4 sm:p-6 shadow-2xs space-y-3">
          <p className="text-xs text-text-secondary font-medium">By using the Insights feature, you agree that:</p>
          <ul className="text-xs text-text-secondary space-y-1.5 list-disc list-inside pl-1">
