  ...
  return (
    <div className="space-y-5 sm:space-y-6 w-full max-w-full min-w-0">
      ...
      <div className="space-y-2">
        ...
        <div className="rounded-2xl border border-border-default bg-surface-primary p-4 sm:p-6 shadow-2xs space-y-4">
          <p className="text-xs text-text-secondary font-medium">We may collect the following categories of information:</p>

          <div className="space-y-3 pt-1">
            <div className="p-3.5 rounded-xl bg-surface-subtle border border-border-default space-y-1.5">
              <p className="text-xs font-bold text-text-primary">Account Information</p>
              <p className="text-[11px] text-text-muted">When you create an account, we may collect:</p>
              <ul className="text-xs text-text-secondary space-y-1 list-disc list-inside pl-1">
                <li>name,</li>
                <li>username,</li>
                <li>email address,</li>
            ...
            <div className="p-3.5 rounded-xl bg-surface-subtle border border-border-default space-y-1.5">
              <p className="text-xs font-bold text-text-primary">Content and Activity</p>
              <p className="text-[11px] text-text-muted">We may collect:</p>
              <ul className="text-xs text-text-secondary space-y-1 list-disc list-inside pl-1">
            ...
            <div className="p-3.5 rounded-xl bg-surface-subtle border border-border-default space-y-1.5">
              <p className="text-xs font-bold text-text-primary">Technical Information</p>
              <p className="text-[11px] text-text-muted">We may collect:</p>
              <ul className="text-xs text-text-secondary space-y-1 list-disc list-inside pl-1">
                <li>device type,</li>
                <li>browser type,</li>
      ...
      <div className="space-y-2">
        ...
        <div className="rounded-2xl border border-border-default bg-surface-primary p-4 sm:p-6 shadow-2xs space-y-3">
          <p className="text-xs text-text-secondary font-medium">We use personal information to:</p>
      ...
      <div className="space-y-2">
        ...
        <div className="rounded-2xl border border-border-default bg-surface-primary p-4 sm:p-6 shadow-2xs space-y-3">
          <p className="text-xs text-text-secondary font-medium">We may share information:</p>
          <ul className="text-xs text-text-secondary space-y-1.5 list-disc list-inside pl-1">
          ...
          <div className="p-3 rounded-xl bg-surface-subtle border border-border-default text-xs text-text-primary font-semibold">
      ...
      <div className="space-y-2">
        ...
        <div className="rounded-2xl border border-border-default bg-surface-primary p-4 sm:p-6 shadow-2xs space-y-3">
          ...
          <p className="text-xs text-text-secondary leading-relaxed pt-1">
            You may also update your profile information or delete your account permanently directly within the Service (<strong className="text-text-primary">Settings &gt; Account &gt; Delete Account</strong>).
          </p>
        </div>
      </div>
