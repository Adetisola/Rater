...
const { updateProfile } = useAuthActions();
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-canvas p-4">
      <div className="bg-surface-elevated w-full max-w-md rounded-[32px] p-8 shadow-2xl border border-border-default flex flex-col items-center relative overflow-hidden min-h-[450px]">
        
        {isGeneratingUsername ? (
           <div className="absolute inset-0 flex flex-col items-center justify-center">
             <Loader2 className="w-8 h-8 text-primary animate-spin mb-4" />
             <p className="text-sm text-text-muted animate-pulse">Setting up your profile...</p>
           </div>
        ) : (
            ...
            {step === 'username' ? (
              ...
              >
                <div className="text-center mb-8 mt-4">
                  ...
                  <p className="text-text-muted text-sm px-4">This will be your public @username. People can search and mention you with it.</p>
                </div>
                ...
                <div className="w-full space-y-6 px-1">
                  <div className="relative group">
                    ...
                    <Input
                      ...
                      className={cn(
                        "h-12 pl-[115px] pr-4 text-base font-normal rounded-xl border transition-all outline-none text-text-primary",
                  ...
                  {error && (
                    <div className="p-3 bg-red-500/10 text-red-500 text-sm rounded-xl border border-red-500/20 mb-2 mt-2">
                      {error}
                    </div>
                  )}
