    ...
    <div className="max-w-7xl mx-auto space-y-8 animate-in fade-in duration-300">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <Button
            ...
            onClick={loadStats}
            disabled={isLoading}
            className="h-9 px-3.5 rounded-xl text-xs font-bold inline-flex items-center gap-2 bg-white"
          >
      ...
      {error && (
        <div className="p-4 rounded-2xl bg-red-50 border border-red-100 text-red-700 text-sm font-medium flex items-center justify-between">
          <span>{error}</span>
          <Button variant="ghost" onClick={loadStats} className="text-xs font-bold text-red-700 h-8">
            Retry
          </Button>
        </div>
      )}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
        ...
        <div className="bg-white p-6 rounded-3xl border border-gray-100 shadow-sm relative overflow-hidden group hover:border-gray-200 transition-all">
          <div className="flex items-center justify-between mb-4">
            <span className="text-xs font-bold text-gray-400 uppercase tracking-wider">Posts & Media</span>
        ...
        <div className="bg-white p-6 rounded-3xl border border-gray-100 shadow-sm relative overflow-hidden group hover:border-gray-200 transition-all">
          <div className="flex items-center justify-between mb-4">
            <span className="text-xs font-bold text-gray-400 uppercase tracking-wider">Post Views</span>
        ...
        <div className="bg-white p-6 rounded-3xl border border-gray-100 shadow-sm flex flex-col justify-between">
          <div className="flex items-start justify-between gap-4 mb-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-lg font-bold text-gray-900">Safety & Abuse Reports</h2>
          ...
          <Link
            href="/admin/reports"
            className="inline-flex items-center justify-between w-full mt-4 pt-4 border-t border-gray-100 text-sm font-bold text-gray-700 hover:text-black group"
          >
        ...
        <div className="bg-white p-6 rounded-3xl border border-gray-100 shadow-sm flex flex-col justify-between">
          <div className="flex items-start justify-between gap-4 mb-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-lg font-bold text-gray-900">Feedback Management</h2>
      ...
      <div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          >
            <div className="flex items-center justify-between text-gray-900 font-bold text-sm mb-1">
