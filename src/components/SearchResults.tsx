    ...
    <>
      ...
      >
        ...
        {results.categories.length > 0 && (
          <div className="border-b border-gray-100">
            <div className="px-4 py-2 bg-gray-50">
              <span className="text-xs font-semibold text-gray-500 tracking-wide">Categories</span>
            </div>
            <div className="p-2">
        ...
        {results.avatars.length > 0 && (
          <div className="border-b border-gray-100">
            <div className="px-4 py-2 bg-gray-50">
              <span className="text-xs font-semibold text-gray-500 tracking-wide">Creatives</span>
            </div>
            <div className="p-2">
        ...
        {results.posts.length > 0 && (
          <div>
            <div className="px-4 py-2 bg-gray-50">
              <span className="text-xs font-semibold text-gray-500 tracking-wide">Works</span>
            </div>
            <div className="p-2">
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        ...
        <p className="text-xs text-gray-400">{avatar.role || 'User'}</p>
      </div>
    </div>
  );
}
