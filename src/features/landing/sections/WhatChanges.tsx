...
const gradientArrow = '/assets/landing/what-changes/Gradient Arrow.svg';
const whatChangesVisual = '/assets/landing/what-changes/what changes-visual.png';
const starIcon = '/icons/star-active-yellow.svg';
