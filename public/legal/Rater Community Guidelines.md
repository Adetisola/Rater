...
If you leave feedback, try to make it useful.
...
Do not inflate ratings just because you know the creator.

Do not tank ratings because you are in a bad mood.
...
Reviews should be about the creative work being reviewed.

Do not spam unrelated content, random phrases, copied text, or off-topic messages.
...
* spam reviews,
* coordinate fake ratings,
* create fake engagement,
* repeatedly submit meaningless feedback,
...
Only upload work you have the right to share.

Do not upload stolen content, unauthorized copies, or content that violates another person’s rights.

If you reference someone else’s work, make sure you have permission or a valid reason to share it.
...
* or try to bypass platform rules.
